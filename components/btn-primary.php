...
?>
<a class="inline-flex items-center gap-2 <?= htmlspecialchars($btn_extra_class) ?> bg-primary text-on-primary font-handwriting text-label-mono px-6 py-3 uppercase tracking-wider shadow-[4px_4px_0px_0px_#000101] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-[2px_2px_0px_0px_#000101] transition-all" href="<?= htmlspecialchars($btn_href) ?>"><?= $btn_text ?></a>
