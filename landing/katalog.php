...
<button class="font-label-mono text-xs text-deep-black underline underline-offset-4 hover:text-deep-black transition-colors">Reset Filter</button>
</div>
...
<div class="font-label-mono text-[10px] text-deep-black uppercase mb-2">Anak-anak</div>
...
<div class="p-4 flex flex-col flex-1">
<div class="font-label-mono text-[10px] text-deep-black uppercase mb-2">Sains & Alam</div>
...
<div class="p-4 flex flex-col flex-1">
<div class="font-label-mono text-[10px] text-deep-black uppercase mb-2">Sastra</div>
...
<div class="p-4 flex flex-col flex-1">
<div class="font-label-mono text-[10px] text-deep-black uppercase mb-2">Sejarah</div>
