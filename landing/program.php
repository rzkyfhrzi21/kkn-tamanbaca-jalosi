...
<section class="w-full bg-surface py-20 px-margin-mobile lg:px-margin-desktop relative overflow-hidden">
<div class="absolute top-0 right-0 w-1/3 h-full bg-tertiary-container/10 -skew-x-12 transform origin-top-right"></div>
<div class="max-w-[1200px] mx-auto relative z-10">
<div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
<div>
<div class="inline-flex items-center justify-center bg-sticker-green text-deep-black font-label-stamp px-3 py-1 mb-6 shadow-[2px_2px_0px_0px_#000101] border border-deep-black">
            PROGRAM KAMI
          </div>
<h1 class="font-headline-lg text-deep-black mb-6">Kurikulum <br/>Berbasis Komunitas</h1>
...
<div class="absolute inset-0 bg-white border border-deep-black shadow-[2px_2px_0px_0px_#000101] -rotate-1 transform transition-transform hover:rotate-0 overflow-hidden">
<div class="w-full h-full bg-cover bg-center mix-blend-multiply" data-alt="Children gathered around a wooden table in a rustic, well-lit room, reading books and smiling. The scene is warm, tactile, and grounded, evoking a community learning environment with natural light and wooden textures." style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuCpEJLFKHOwxs7Xd_pYqKrnNA5Nln5u0NaZ-HeuGVsnWodbCe74DBDHXuUfo7v0FHckLUl-AmR8Na53UW3z_VZDGWFyCMeZZUZFSa8gfRFptJzcGQK1985HawjeKTzuPzHJuFA55EO9WKjF-yfOlucNUOkRToj1Ch_rev-eLAUwSV9hydTHsQ-aDaelrIRbVRexjrjla5r4rf7yRla8vZ7-8c6nyg5HM7QX2eZ2xaWQQo2DF_6m3REZ')"></div>
</div>
<div class="absolute -bottom-4 -left-4 bg-sticker-green text-deep-black font-label-stamp px-4 py-2 border border-deep-black shadow-[2px_2px_0px_0px_#000101] -rotate-6">
              #BelajarBersama
           </div>
</div>
</div>
...
<section class="w-full bg-inverse-surface py-24 px-margin-mobile lg:px-margin-desktop border-t border-deep-black relative">
<div class="max-w-[1200px] mx-auto">
<div class="flex items-center gap-4 mb-16">
<span class="font-headline-lg text-sticker-green opacity-50">01</span>
<h2 class="font-headline-md text-surface uppercase">Pilar Program</h2>
</div>
